def hitung_gain(jumlah_lot, harga_beli, harga_sekarang):
    ...
    return jumlah_lembar, harga_beli_awal, total_gain, total_aset
...
try:
    ...
    jumlah_lembar, harga_beli_awal, gain, total_aset = hitung_gain(jumlah_lot, harga_beli, harga_sekarang)
