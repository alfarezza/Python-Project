...
try:
    ...
    print(f"Total nilai beli        : Rp {hasil['nilai_beli']:,}")
    print(f"Total biaya beli        : Rp {hasil['biaya_beli']:,}")
    print(f"Total modal             : Rp {hasil['total_modal']:,}")
    print(f"Harga jual per lembar   : Rp {harga_sekarang:,}")
    print(f"Total nilai jual        : Rp {hasil['nilai_jual']:,}")
    print(f"Total biaya jual        : Rp {hasil['biaya_jual']:,}")
    print(f"Nilai bersih penjualan  : Rp {hasil['hasil_bersih_jual']:,}")
    print(f"Gain/Loss bersih        : Rp {hasil['gain_bersih']:,}")
